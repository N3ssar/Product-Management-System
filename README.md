...
## Usage
1. **Add a Product**:
   - Fill in the product details in the form at the top of the page
   - Click the "Create" button to add the product to your inventory

2. **Search for Products**:
   - Use the search bar to find products by title or category
   - Click on the appropriate search mode button (By Title or By Category)
...
4. **Delete Products**:
   ...
   - Use "Delete All" to remove all products (requires confirmation)
